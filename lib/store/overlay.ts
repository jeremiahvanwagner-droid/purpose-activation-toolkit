...
export const PRODUCTS: ProductMeta[] = [
  ...
  },
  {
    ...
    checkout: { kind: "book", href: booking("Kd7Abr9dHslUyk5dw5V5"), label: "Request an interview" },
  ...
  },
  {
    ...
    checkout: { kind: "book", href: booking("Bv3RgsvVaN0jcLm2oU3H"), label: "Book a discovery call" },
  ...
  },
  {
    ...
    checkout: { kind: "book", href: booking("UKcFtiWbcDQZvZ0ODp7h"), label: "Request an exploration call" },
